# 12 временных и аспектуальных форм
...
| Форма | Утверждение | Отрицание | Вопрос | Значение | Примеры | Контраст / ограничение |
| --- | --- | --- | --- | --- | --- | --- |
...
1. She ___ every weekday. (work; привычка)
2. Right now she ___ the logs. (read)
3. Yesterday we ___ the backup. (restore)
4. I ___ the file, so you can open it now. (upload; результат)
5. When I called, he ___ . (drive; процесс)
6. The job ___ before we arrived. (finish; предшествование)
7. She ___ for two hours and is still waiting. (wait; процесс)
8. They ___ for an hour when the bus came. (wait; процесс)
9. I promise I ___ your password. (not share)
10. At noon tomorrow I ___ to Rome. (fly; процесс)
11. By Friday we ___ the report. (finish; завершённость)
12. By July I ___ here for a year. (work; длительность процесса)
13. Исправь Did she went home?
14. Исправь I will call when I will arrive.
15. Объясни I have read it / I have been reading it.
16. Объясни Why are you being rude? / You are rude.

<details><summary>Разбор после попытки</summary>

1. works — third-person -s.
2. is reading — процесс сейчас.
3. restored — завершённое прошлое.
4. have uploaded — результат к настоящему.
5. was driving — фон в прошлый момент.
6. had finished — раньше другого прошлого события.
7. has been waiting — длительность до сейчас.
8. had been waiting — длительность до прошлого ориентира.
9. will not share / won’t share — обещание.
10. will be flying — процесс в будущий момент.
11. will have finished — результат к будущему моменту.
12. will have been working — длительность до будущего ориентира.
13. Did she go home? — did уже несёт прошедшее время.
14. I will call when I arrive. — придаточное времени.
15. Первое сообщает о результате; второе — о процессе, не гарантируя завершение.
16. Временное поведение сейчас / общая характеристика. Continuous со state-like be возможен при таком изменении смысла.
