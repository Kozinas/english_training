...
| Буква | Строчная | Имя (IPA) | Буква в словах |
| --- | --- | --- | --- |
| A | a | /eɪ/ | apple /æ/; name /eɪ/ |
| B | b | /biː/ | book /b/ |
| C | c | /siː/ | cat /k/; city /s/ |
| D | d | /diː/ | desk /d/ |
| E | e | /iː/ | end /e/; he /iː/ |
| F | f | /ef/ | file /f/ |
| G | g | /dʒiː/ | go /ɡ/; page /dʒ/ |
| H | h | /eɪtʃ/ | hello /h/; hour — немая h |
| I | i | /aɪ/ | sit /ɪ/; time /aɪ/ |
| J | j | /dʒeɪ/ | job /dʒ/ |
| K | k | /keɪ/ | key /k/; know — немая k |
| L | l | /el/ | late /l/ |
| M | m | /em/ | name /m/ |
| N | n | /en/ | new /n/ |
| O | o | /əʊ/ | not /ɒ/; go /ɡəʊ/ |
| P | p | /piː/ | pen /p/ |
| Q | q | /kjuː/ | quick /kw/ |
| R | r | /ɑː/ | red /r/; US имя буквы /ɑːr/ |
| S | s | /es/ | sit /s/; is /z/ |
| T | t | /tiː/ | team /t/ |
| U | u | /juː/ | cup /ʌ/; use /juːz/ |
| V | v | /viː/ | very /v/ |
| W | w | /ˈdʌbəljuː/ | we /w/ |
| X | x | /eks/ | box /ks/; exam /ɡz/ |
| Y | y | /waɪ/ | yes /j/; my /aɪ/ |
| Z | z | /zed/ | zero /z/; US имя буквы /ziː/ |

## Практика

1. Назови по буквам API.
2. Назови по буквам URL.
3. Различи имя E и I.
4. Различи G и J.
5. Различи B, P и V.
6. Продиктуй вымышленное имя Kim.
7. Продиктуй буквы в code, затем прочти слово.
8. Запиши букву с именем /waɪ/.
9. Запиши букву с именем /juː/.
10. Назови два нормативных имени Z.
11. Найди в cat и city звуки буквы c.
12. Попроси повторить последнюю букву.

<details><summary>Разбор после попытки</summary>

1. A /eɪ/, P /piː/, I /aɪ/.
2. U /juː/, R /ɑː/ или /ɑːr/, L /el/.
3. E /iː/, I /aɪ/.
4. G /dʒiː/, J /dʒeɪ/.
5. /biː/, /piː/, /viː/.
6. K-I-M: /keɪ aɪ em/.
7. C-O-D-E; слово /kəʊd/, не цепочка имён букв.
8. Y.
9. U.
10. /zed/, /ziː/.
11. /k/ и /s/.
12. Could you repeat the last letter, please? — допустимы другие вежливые формулировки.
