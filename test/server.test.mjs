...
test('local server serves course assets and excludes private/repository paths',async()=>{
  ...
  try{
    for(const route of ['/','/styles.css','/app.mjs','/engine.mjs','/learning.mjs','/data/course.mjs','/data/assessment.mjs','/data/p01.mjs','/data/unit-tools.mjs','/data/lexicon.mjs','/data/reference.mjs','/data/irregular.mjs']){
