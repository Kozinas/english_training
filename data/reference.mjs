...
import {perfectContinuousReference,pastPerfectReference,habitsReference} from './duration-history.mjs';
import {conditionalReference,wishPossibilityReference} from './hypothesis-reference.mjs';
import {passiveReference,serviceReference} from './passive-reference.mjs';
import {reportingReference,questionTagReference} from './reporting-reference.mjs';
import {cohesionReference,wordBuildingReference,correspondenceReference} from './writing-reference.mjs';
import {pastDurationReference,futureFrameReference,futureResultReference} from './time-perspectives.mjs';
import {counterfactualReference,modalPastReference} from './past-alternatives.mjs';
import {advancedRelativeReference,participleReference,groupDeterminerReference} from './clause-precision.mjs';
...
import {nominalReference,textReference,editingReference} from './dense-text-reference.mjs';
import {intentReference,idiomsReference,negotiationReference} from './pragmatics-reference.mjs';
import {sourceReference,synthesisReference,argumentReference as extendedArgumentReference} from './synthesis-reference.mjs';
import {scopeReference,modalInterpretationReference,aspectReference} from './precision-reference.mjs';
import {idiomaticReference,economyReference,revisionReference} from './style-reference.mjs';
import {inferenceReference} from './inference-reference.mjs';
