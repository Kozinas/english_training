...
const routes=new Map([
 ...
 ...['course','foundation','intermediate','advanced','technical','assessment','reference','irregular','numbers','nouns','be-questions','present-simple','lexicon','lexicon-p02','lexicon-p03','lexicon-p04','lexicon-a101','p01','p02','p02-numbers','p02-time','p02-instructions','p03','p03-nouns','p03-articles','p03-reference','p03-possession','p04','p04-statements','p04-yesno','p04-wh','a101','a101-forms','a101-negatives','a101-questions','a101-frequency','unit-tools'].map(n=>['/data/'+n+'.mjs','data/'+n+'.mjs'])
]);
