...
const routes=new Map([
 ...
 ...['course','foundation','intermediate','advanced','technical','assessment','reference','irregular','numbers','lexicon','lexicon-p02','p01','p02','p02-numbers','p02-time','p02-instructions','unit-tools'].map(n=>['/data/'+n+'.mjs','data/'+n+'.mjs'])
]);
