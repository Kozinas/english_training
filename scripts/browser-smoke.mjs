...
import {checkB101} from './b101-smoke.mjs';
import {checkB102} from './b102-smoke.mjs';
import {checkB103} from './b103-smoke.mjs';
import {checkB104} from './b104-smoke.mjs';
import {checkB105} from './b105-smoke.mjs';
import {checkB201} from './b201-smoke.mjs';
import {checkB202} from './b202-smoke.mjs';
import {checkB203} from './b203-smoke.mjs';
...
import {checkC103} from './c103-smoke.mjs';
import {checkC104} from './c104-smoke.mjs';
...
try{
  ...
  await route('module/C105','#self-check');await assertTopicBars();
  ...
  await route('module/C105','#self-check');await assertTopicBars();assert(await evaluate('document.documentElement.scrollWidth<=window.innerWidth'),'legacy progress mobile overflow');await screenshot('progress-legacy-mobile.png');
  ...
  await checkB101({evaluate,route,command,poll,screenshot,delay,importSynthetic});
  await checkB102({evaluate,route,command,poll,screenshot,delay,importSynthetic});
  await checkB103({evaluate,route,command,poll,screenshot,delay,importSynthetic});
  await checkB104({evaluate,route,command,poll,screenshot,delay,importSynthetic});
  await checkB105({evaluate,route,command,poll,screenshot,delay,importSynthetic});
  await checkB201({evaluate,route,command,poll,screenshot,delay,importSynthetic});
  await checkB202({evaluate,route,command,poll,screenshot,delay,importSynthetic});
  await checkB203({evaluate,route,command,poll,screenshot,delay,importSynthetic});
  ...
  await checkC103({evaluate,route,command,poll,screenshot,delay,importSynthetic});
  await checkC104({evaluate,route,command,poll,screenshot,delay,importSynthetic});
